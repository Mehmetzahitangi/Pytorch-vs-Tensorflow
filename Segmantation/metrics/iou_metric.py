...
# all data
jac = jaccard_score(prediction.flatten(),target.flatten(),average = "macro",labels=[0,72,147]) # It doesn't take the label imbalance and calculates it directly, it's the same as above, but we can't see it for every label.
